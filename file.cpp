...
string CityName[] = {"WareHouse", "Agra", "Kanpur", "Aligarh", "Lucknow", "Muradabad", "Quetta", "Gurgaon", "Sultanpur", "Ghaziabad", "Liaquat Bagh"};

string Gurgaon[]={"Gurgaon", "Comsats Atd", "PMA", "PC Hotel", "Ayub Medical College", "Fawara Chowk"};

string Agra[]={"Agra", "I-8" ,"Askari-14", "F-10", "F-7", "H-12"};

string Kanpur[]={"Kanpur", "Johar Town", "Garden Town", "DHA", "Model Town", "Comsats Kanpur"};

string Aligarh[]={"Aligarh", "Bharia Twon", "North Nazimabad", "Defence", "Clifton", "Liyari"};

int graph[V][V]={   {0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 3},   //Warehouse
					{4, 0, 0, 0, 0, 0, 0, 6, 0, 0, 2},	 //Agra
					{0, 0, 0, 0, 9, 4, 0, 0, 0, 0, 11},	 //Kanpur
					{0, 0, 0, 0, 1, 0, 0, 0, 16, 5, 0},	 //Aligarh
					{0, 0, 9, 1, 0, 8, 13, 0, 10, 6, 0}, //Lucknow	
					{0, 0, 4, 0, 8, 0, 0, 3, 17, 0, 7},	 //Muradabad
					{0, 0, 0, 0, 13, 0, 0, 0, 0, 0, 7},	 //Quetta
					{0, 6, 0, 0, 0, 3, 0, 0, 5, 0, 0},	 //Gurgaon
					{0, 0, 0, 16, 10, 17, 0, 5, 0, 0, 0},//Sultanpur
					{0, 0, 0, 5, 6, 0, 0, 0, 0, 0, 0},	 //Ghaziabad
					{3, 2, 11, 0, 0, 7, 7, 0, 0, 0, 0}  };//Chandigarh
...
int isb(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Agra: " << endl;
...
int Atd(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Gurgaon: " << endl;
...
int Kar(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Aligarh: " << endl;
...
int main()
{
	shop =new Shop;
	shop->name="WareHouse";
	shop->address="Chandni Chowk, New Delhi";
